...
export abstract class SpriteQueueBase {
    constructor(public oam: Uint8Array) {}
    ...
    initialize(scanline: number, dblHeight: boolean) {
        ...
        for (let i = 0; i < this.length; i++) {
            ...
            const data = this.readTileData(flag, (dblHeight ? tileIndex & 0xfe : tileIndex) * 8 + y);
            ...
            this.flag[i] = flag;
            this.palette[i] = this.getPalette(flag);
        }
    }
