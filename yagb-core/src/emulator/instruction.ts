...
apply(0xd3, { op: Operation.reserved });
apply(0xdb, { op: Operation.reserved });
apply(0xdd, { op: Operation.reserved });
apply(0xe3, { op: Operation.reserved });
apply(0xe4, { op: Operation.reserved });
apply(0xeb, { op: Operation.reserved });
apply(0xec, { op: Operation.reserved });
apply(0xed, { op: Operation.reserved });
apply(0xf4, { op: Operation.reserved });
apply(0xfc, { op: Operation.reserved });
apply(0xfd, { op: Operation.reserved });
...
apply(0x86, {
    ...
    mode1: AddressingMode.reg8,
    par2: r16.hl,
    mode2: AddressingMode.reg16ind8,
    cycles: 2,
    len: 1,
});
apply(0x8e, {
...
apply(0xf0, {
    ...
    par1: r8.a,
    mode1: AddressingMode.reg8,
    mode2: AddressingMode.imm8io,
    cycles: 3,
    len: 2,
});
apply(0xe0, {
    op: Operation.ld,
    mode1: AddressingMode.imm8io,
    par2: r8.a,
    mode2: AddressingMode.reg8,
    cycles: 3,
    len: 2,
...
apply(0xea, {
    op: Operation.ld,
    mode1: AddressingMode.imm16ind8,
    par2: r8.a,
    mode2: AddressingMode.reg8,
    cycles: 4,
    len: 3,
...
apply(0xfa, {
    ...
    par1: r8.a,
    mode1: AddressingMode.reg8,
    mode2: AddressingMode.imm16ind8,
    cycles: 4,
    len: 3,
});
...
apply(0x08, {
    op: Operation.ld,
    mode1: AddressingMode.imm16ind16,
    par2: r16.sp,
    mode2: AddressingMode.reg16,
    cycles: 5,
    len: 3,
});
apply(0xf8, {
