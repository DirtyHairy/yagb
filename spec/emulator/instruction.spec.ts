        ...
        describe.each([
            {
                ...
                entries: [
                    { op: 'DB 0xd3', expected: '', opcode: 0xd3, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xdb', expected: '', opcode: 0xdb, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xdd', expected: '', opcode: 0xdd, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xe3', expected: '', opcode: 0xe3, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xe4', expected: '', opcode: 0xe4, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xeb', expected: '', opcode: 0xeb, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xec', expected: '', opcode: 0xec, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xed', expected: '', opcode: 0xed, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xf4', expected: '', opcode: 0xf4, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xfc', expected: '', opcode: 0xfc, par1: 0x00, par2: 0x00 },
                    { op: 'DB 0xfc', expected: '', opcode: 0xfc, par1: 0x00, par2: 0x00 },
                ],
            },
            {
