    ...
    describe('disassembleInstruction', () => {
        describe.each([
            ...
            },
            {
                ...
                entries: [
                    { op: 'LD (FF00 + a8), A', expected: 'LD (FF00 + 0x00), A', opcode: 0xe0, par1: 0x00, par2: 0x00 },
                ]
            },
            {
            ...
            },
            {
                ...
                entries: [
                    { op: 'LD A, (FF00 + a8)', expected: 'LD A, (FF00 + 0x00)', opcode: 0xf0, par1: 0x00, par2: 0x00 },
                ]
            },
            {
            ...
            },
            {
                ...
                entries: [
                    { op: 'LD A, (FF00 + C)', expected: 'LD A, (FF00 + C)', opcode: 0xf2, par1: 0x00, par2: 0x00 },
                ]
            },
            {
                description: 'with first reg8 value and second imm16ind8 value',
                entries: [
                    { op: 'LD A, (a16)', expected: 'LD A, (0x0000)', opcode: 0xfa, par1: 0x00, par2: 0x00 },
                ]
            },
            {
            ...
            },
            {
                ...
                entries: [
                    { op: 'LD (FF00 + C), A', expected: 'LD (FF00 + C), A', opcode: 0xe2, par1: 0x00, par2: 0x00 },
                ]
            },
            {
                description: 'with first imm16ind8 value and second reg8 value',
                entries: [
                    { op: 'LD (a16), A', expected: 'LD (0x0000), A', opcode: 0xea, par1: 0x00, par2: 0x00 },
                ]
            },
            {
        ...
        ])('$description', ({description: string, entries}) => {
