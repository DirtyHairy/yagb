...
apply(0xc6, { op: Operation.add, mode1: AddressingMode.imm8, cycles: 2, len: 2 });
apply(0xce, { op: Operation.adc, mode1: AddressingMode.imm8, cycles: 2, len: 2 });
apply(0xd6, { op: Operation.sub, mode1: AddressingMode.imm8, cycles: 2, len: 2 });
apply(0xde, { op: Operation.sbc, mode1: AddressingMode.imm8, cycles: 2, len: 2 });
